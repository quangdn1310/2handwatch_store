...
import { Reveal, Carousel } from '@/components/ui';
            ...
            <div className="container space-y-16">
                ...
                >
                    {reviews.map((review, index) => (
                        <div key={index} className="card p-8 h-full flex flex-col justify-between space-y-8 bg-black/40 backdrop-blur-sm border border-white/5 hover:border-accent/30 transition-all duration-500">
